...
CREATE TABLE IF NOT EXISTS `instituciones_deportivas` (
  ...
  `creado_en` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ruc_institucion` (`ruc_institucion`),
...
CREATE TABLE IF NOT EXISTS `solicitudes_registro` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre_institucion` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `ruc_institucion` varchar(11) COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  CONSTRAINT `solicitudes_registro_ibfk_1` FOREIGN KEY (`revisado_por`) REFERENCES `usuarios_instalaciones` (`id`) ON DELETE SET NULL
...
-- Volcando datos para la tabla railway.solicitudes_registro: ~2 rows (aproximadamente)
INSERT INTO `solicitudes_registro` (`id`, `nombre_institucion`, `ruc`, `email`, `password`, `documento_path`, `estado`, `motivo_rechazo`, `fecha_solicitud`, `fecha_revision`, `revisado_por`) VALUES
	...
	(2, 'canchapero', '99999999999', 'myrayita2004@gmail.com', '$2y$10$ndWhStrtgsn7lx/3RpZdYueOQJ15ceFgLZyAgw3nRRnaTHFR4S4gK', 'https://cdn.filestackcontent.com/bDeKviLRSwe1Zl66GbP8', 'pendiente', NULL, '2025-06-24 21:14:51', NULL, NULL);
