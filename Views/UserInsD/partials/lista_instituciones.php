<?php
$model = $institucionesController->getModel();
$total_instalaciones = $institucionesController->contarTotalInstalaciones();
$total_areas = $institucionesController->contarTotalAreas();
?>
...
<!-- Aquí terminan las tarjetas resumen -->
