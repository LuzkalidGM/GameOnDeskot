        ...
        <div class="auth-container">
            ...
            <div class="auth-body">
                ...
                <div class="info-box">
                    ...
                    <strong>Instrucciones:</strong> Ingresa el correo electrónico asociado a tu cuenta. Si el correo está registrado, recibirás un enlace para restablecer tu contraseña.
                </div>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" id="forgotPasswordForm">
                    ...
                    <input type="hidden" name="user_type" value="ipd">
                    <div class="form-group">
